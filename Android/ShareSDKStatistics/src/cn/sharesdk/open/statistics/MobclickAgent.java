...
public class MobclickAgent {
	...
	/**update the report policy from the server*/
	 ...
	 */
	public static void setUpdateOnlyWifi(final Context context, final boolean isUpdateonlyWifi) {
		log.setWifiReportPolicy(context, isUpdateonlyWifi);
	}
